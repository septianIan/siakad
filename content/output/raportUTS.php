			...
			<html>
				...
				<body style="font-family:'tahoma';font-size:12px;overflow-x:hidden;">
					<div style="width:1.5cm;height:1cm;border:Solid 2px dodgerblue;position:fixed;margin:400 0 0 -15;background:#efefef;font-size:10px;" id="action1">
						<a href="raportUTSPdf.php?<?echo paramEncrypt('id='.$decode['id'])?>"  title="Simpan PDF">
					...
					<div style="width:26.5cm;height:19.5cm;">
						<div style="height:15%;width:98%;margin:0 0 0 8;border-bottom:solid 1px black;">
							<div style="width:80px;height:80px;margin:10 0 0 175;float:left;">
						...
						<div style="height:89%;width:98%;margin:0 0 0 8;font-size:12px;">
							<div style="width:500px;height:60px;float:left;margin:10 0 0 20;">
							...
							<table style="margin:10 20 0 20;font-size:12px;">
								<tr style="text-align:Center;font-weight:bold;background:#b0e0e6;height:20px;">
									<td rowspan="3" style="width:50px;border-right:solid 1px #ccc;border-left:solid 1px #ccc;">NO</td>
									<td rowspan="3" style="width:250px;border-right:solid 1px #ccc;">MATA PELAJARAN</td>
									<td colspan="9" style="border-right:solid 1px #ccc;">PENGETAHUAN</td>
									<td rowspan="3" style="width:50px;border-right:solid 1px #ccc;">UTS</td>
									<td colspan="9" style="border-right:solid 1px #ccc;">KETERAMPILAN</td>
									<td colspan="2" style="width:50px;border-right:solid 1px #ccc;">SIKAP</td>
								</tr>
								<tr style="text-align:Center;font-weight:bold;background:#b0e0e6;height:20px;">
									<td colspan="3" style="border-right:solid 1px #ccc;">TUGAS</td>
									<td colspan="6" style="border-right:solid 1px #ccc;">ULANGAN HARIAN</td>
									<td colspan="3" style="border-right:solid 1px #ccc;">PRAKTEK</td>
									<td colspan="3" style="border-right:solid 1px #ccc;">PROJECT</td>
									<td colspan="3" style="border-right:solid 1px #ccc;">PORTOFOLIO</td>
									<td rowspan="2" style="width:50px;border-right:solid 1px #ccc;">DALAM MAPEL<br>SB/B/C/K</td>
									<td rowspan="2" style="width:50px;border-right:solid 1px #ccc;">ANTAR MAPEL<br>DESKRIPSI</td>
								</tr>
								<tr style="text-align:Center;font-weight:bold;background:#b0e0e6;height:20px;">
									<?
										for($a=1;$a<=3;$a++)
							...
							<div style="float:left;margin:10 0 0 0;">
								...
								<table style="font-size:12px;margin:5 10 0 20;">
									<tr style="text-align:center;font-weight:bold;background:#b0e0e6;height:20px;">
										<td style="width:50px;border-right:solid 1px #ccc;border-left:solid 1px #ccc;">NO</td>
										<td style="width:150px;border-right:solid 1px #ccc;">JENIS KEGIATAN</td>
										<td style="width:100px;border-right:solid 1px #ccc;">PREDIKAT</td>
							...
							<div style="float:left;margin:10 0 0 0;">
								...
								<table style="font-size:12px;margin:5 0 0 0;">
									<?
									...
									<tr style="text-align:center;font-weight:bold;background:#b0e0e6;height:20px;">
										<td style="width:50px;border-right:solid 1px #ccc;border-left:solid 1px #ccc;">NO</td>
										<td style="width:300px;border-right:solid 1px #ccc;">ALASAN</td>
										<td style="width:100px;border-right:solid 1px #ccc;">LAMA</td>
									</tr>
									<tr style="height:15px;">
										<td style="width:50px;border-right:solid 1px #ccc;border-left:solid 1px #ccc;text-align:center;">1</td>
										<td style="width:300px;border-right:solid 1px #ccc;">Ijin</td>
										<td style="width:100px;border-right:solid 1px #ccc;text-align:center;">
											<?
									...
									<tr style="height:15px;">
										...
										<td style="width:300px;border-right:solid 1px #ccc;">Sakit</td>
										<td style="width:100px;border-right:solid 1px #ccc;text-align:center;">
											<?
									...
									<tr style="height:15px;">
										...
										<td style="width:300px;border-right:solid 1px #ccc;">Tanpa Keterangan</td>
										<td style="width:100px;border-right:solid 1px #ccc;text-align:center;">
											<?
