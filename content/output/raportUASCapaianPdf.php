<?	
		...
		?>	
			<html>
				...
				<body style="font-family:'tahoma';font-size:12px;overflow-x:hidden;">
					<img src="../../images/Pic/logo.png" style="float:left;margin:5 0 0 30;" width="75" height="75">
					...
					<table style="margin:10 20 0 20;font-size:12px;">
						<tr style="text-align:Center;font-weight:bold;background:#b0e0e6;height:20px;">
							...
							<td rowspan="2" style="width:200px;border:solid 1px #ccc;">MATA PELAJARAN</td>
							<td rowspan="2" style="width:100px;border:solid 1px #ccc;">PENGETAHUAN<br>(KI 3)</td>
							<td rowspan="2" style="width:100px;border:solid 1px #ccc;">KETERAMPILAN<br>(KI 4)</td>
							<td colspan="2" style="border:solid 1px #ccc;">SIKAP SPIRITUAL & SOSIAL<br>(KI 1 & KI 2)</td>
						</tr>
						<tr style="text-align:Center;font-weight:bold;background:#b0e0e6;height:20px;">
							<td style="width:100px;border:solid 1px #ccc;">DALAM MAPEL<br>SB/B/C/K</td>
							<td style="width:100px;border:solid 1px #ccc;">ANTAR MAPEL<br>DESKRIPSI</td>
						</tr>
						<?
							$jumSpan = 0;
							$jumAntar = 0;
						...
						<tr style="height:1px;">
							...
							<td></td>
							<td></td>
							<td rowspan="<?echo $jumSpan?>" style="width:100px;border:solid 1px #ccc;font-style:italic;vertical-align:middle;">
								<?
									...
									echo "Secara umum kemampuan<br>sikap spiritual dan sosial <b>".$ketAntar."</b><br>".$saran;
								?>
							</td>
						</tr>
							...
							while($a_selMapel = mysql_fetch_array($selMapel))
							{
								...
								?>
									<tr style="height:15px;text-transform:uppercase;">
										<td colspan="5" style="border:solid 1px #ccc;background:#efefef;border-left:solid 1px #ccc;"><?echo $kelompok?></td>
									</tr>
								<?
					...
					<div style="margin:5 0 0 10">
						...
						<table style="font-size:12px;margin:0 20 0 10;">
							<?
					...
					<div style="width:200px;height:15px;margin:25 0 0 30;font-size:12px;float:left;">
						Orang Tua / Wali Murid
						<br><br><br><br>
						<font style="color:white;">af</font>(..........................)
						<div style="width:200px;height:15px;margin:-67 0 0 370;font-size:12px;text-align:center;">
	...
	$filename="Raport_UAS_Capaian_".$a_detailSiswa['nama']."_".$a_detailSiswa['kelas'].".pdf";
	
	$content = ob_get_clean();
	require_once('html2pdf/html2pdf.class.php');
	try
	{
		$html2pdf = new HTML2PDF('P','A4','en', false, 'UTF-8',array(5, 5, 0, 0));
