<?	
					...
					<div style="width:19.5cm;height:26.5cm;">
						...
						<table style="margin:10 20 0 20;font-size:12px;">
							<tr style="text-align:Center;font-weight:bold;background:#b0e0e6;height:20px;">
								<td rowspan="2" style="width:50px;border:solid 1px #ccc;">NO</td>
								<td rowspan="2" style="width:150px;border:solid 1px #ccc;">MATA PELAJARAN</td>
								<td rowspan="2" style="width:50px;border:solid 1px #ccc;">KKM</td>
								<td colspan="2" style="width:200px;border:solid 1px #ccc;">NILAI</td>
								<td rowspan="2" style="width:150px;border:solid 1px #ccc;">DESKRIPSI</td>
							</tr>
							<tr style="text-align:Center;font-weight:bold;background:#b0e0e6;height:20px;">
								<td style="width:50px;border:solid 1px #ccc;">ANGKA</td>
								<td style="width:150px;border:solid 1px #ccc;">HURUF</td>
							</tr>
							<?
								$no = 1;
								$tot = 0;
								...
								while($a_selPelajaran = mysql_fetch_array($selPelajaran))
								{
									...
									while($a_pelajaranTrigger = mysql_fetch_array($pelajaranTrigger))
									{
										...
										if($a_cekTable['jumTable'] != 0)
										{
											...
											$nAkhir = round(@(((2*$NH) + $nilaiUTS + $nilaiUAS)/4));
											$NA = $NA + $nAkhir;
										}
									...
									?>
										<tr style="height:15px;">
											...
											<td style="width:200px;border:solid 1px #ccc;">
												<?
											...
											<td style="width:125px;border:solid 1px #ccc;text-align:Center;">
												<?
							...
							?>
							<tr style="height:15px;">
								<td colspan="3" style="border:solid 1px #ccc;font-weight:bold;text-align:right;font-style:italic;">Jumlah</td>
								<td style="width:50px;border:solid 1px #ccc;text-align:center;"><?echo $tot?></td>
								<td style="background:#efefef;border:solid 1px #ccc;"></td>
								<td style="background:#efefef;border:solid 1px #ccc;"></td>
							</tr>
							<tr style="height:15px;">
								<td colspan="3" style="border:solid 1px #ccc;font-weight:bold;text-align:right;font-style:italic;">Rata-rata</td>
								<td style="width:50px;border:solid 1px #ccc;text-align:center;">
									<?
						...
						<table style="font-size:12px;margin:0 20 0 20;">
							<tr style="text-align:center;font-weight:bold;background:#b0e0e6;height:20px;">
								<td style="width:50px;border:solid 1px #ccc;">NO</td>
								<td style="width:315px;border:solid 1px #ccc;">JENIS KEGIATAN</td>
								...
								while($a_ekstra = mysql_fetch_array($ekstra))
								{
									?>
										<tr style="height:15px;">
											...
											<td style="width:315px;border:solid 1px #ccc;">
												<?
						...
						<div style="float:left;margin:10 0 0 0;">
							...
							<table style="font-size:12px;margin:5 20 0 20;">
								...
								?>
								<tr style="height:15px;">
									<td style="width:150px;border:solid 1px #ccc;">Akhlak</td>
									<td style="width:100px;border:solid 1px #ccc;text-align:center;"><?echo $a_akhlak['akhlak']?></td>
								</tr>
								<tr style="height:15px;">
									<td style="width:150px;border:solid 1px #ccc;">Kepribadian</td>
									<td style="width:100px;border:solid 1px #ccc;text-align:center;"><?echo $a_akhlak['kepribadian']?></td>
								</tr>
							</table>
						</div>
						...
						<div id="sikap">
							...
							<table style="font-size:12px;margin:5 20 0 10;">
								...
								<tr style="height:15px;">
									...
									<td style="width:100px;border:solid 1px #ccc;">Sakit</td>
									<td style="width:150px;border:solid 1px #ccc;text-align:center;">
										<?
								...
								<tr style="height:15px;">
									...
									<td style="width:100px;border:solid 1px #ccc;">Tanpa Keterangan</td>
									<td style="width:150px;border:solid 1px #ccc;text-align:center;">
										<?
						...
						<div style="width:400px;height:125px;float:left;margin:10 0 0 20;font-size:12px;text-align:left;border:solid 1px white;">
							<div style="border:solid 1px white;width:200px;height:120px;float:left;text-align:center;float:left;">
								Mengetahui<br>
								Orang Tua / Wali Murid
								<br><br><br><br><br>
								(..........................)
							</div>
							<div style="border:solid 1px white;width:200px;height:100px;float:left;text-align:center;float:left;margin:-110 0 0 200;">
								Wali Kelas
								<br><br><br><br><br>
								( <?echo $_SESSION['nama']?> )
							</div>
	...
	$filename="Raport_UAS_".$a_detailSiswa['nama']."_".$a_detailSiswa['kelas'].".pdf";
