			...
			<html>
				...
				<body style="font-family:'tahoma';font-size:12px;overflow-x:hidden;">
					<div style="width:1.5cm;height:1cm;border:Solid 2px dodgerblue;position:fixed;margin:400 0 0 -15;background:#efefef;font-size:10px;" id="action1">
						<a href="raportUASDeskripsiPdf.php?<?echo paramEncrypt('id='.$decode['id'])?>"  title="Simpan PDF">
						...
						<div style="height:89%;width:98%;margin:0 0 0 8;font-size:12px;">
							...
							<table style="margin:10 20 0 20;font-size:12px;">
								<tr style="text-align:Center;font-weight:bold;background:#b0e0e6;height:20px;">
									...
									<td style="width:200px;border-right:solid 1px #ccc;">MATA PELAJARAN</td>
									<td style="width:150px;border-right:solid 1px #ccc;">KOMPETENSI</td>
									<td style="width:500px;border-right:solid 1px #ccc;">CATATAN</td>
								</tr>
								<?
									$no = 1;
									...
									while($a_selMapel = mysql_fetch_array($selMapel))
									{
										...
										?>
											<tr style="height:15px;text-transform:uppercase;">
												<td colspan="4" style="width:200px;border-right:solid 1px #ccc;background:#efefef;border-left:solid 1px #ccc;"><?echo $kelompok?></td>
											</tr>
										<?
										...
										while($a_selPelajaran = mysql_fetch_array($selPelajaran))
										{
											?>
												<tr style="height:15px;">
													<td rowspan="3" style="width:50px;border-right:solid 1px #ccc;border-left:solid 1px #ccc;text-align:center;">
														<?
															echo $no;
														?>
													</td>
													<td rowspan="3" style="width:200px;border-right:solid 1px #ccc;">
														<?
													...
													<td style="width:500px;border-right:solid 1px #ccc;font-style:italic;">
														<?
